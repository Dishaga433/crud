        ...
        Column(children: [
            ...
            TextButton(
              style: TextButton.styleFrom(backgroundColor: Colors.black),
                onPressed: (){create();}, child:Text('CREATE',style: TextStyle(color: Colors.red))),
            SizedBox(
              height: 40,
            ),
            TextButton(
                style: TextButton.styleFrom(backgroundColor: Colors.black),
                onPressed: (){read();}, child:Text('READ',style: TextStyle(color: Colors.red))),
            SizedBox(
              height: 40,
            ),
            TextButton(
                style: TextButton.styleFrom(backgroundColor: Colors.black),
                onPressed: (){update();}, child:Text('UPDATE',style: TextStyle(color: Colors.red))),
            SizedBox(
              height: 40,
            ),
            TextButton(
                style: TextButton.styleFrom(backgroundColor: Colors.black),
                onPressed: (){delete();}, child:Text('DELETE',style: TextStyle(color: Colors.red))),
            SizedBox(
              height: 40,
            ),
          ],
